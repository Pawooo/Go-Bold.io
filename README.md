...
4. <dialog> element [[2]]([https://developer.mozilla.org/en-US/docs/Web/HTML/Element/dialog](url)) [[3]](https://webkit.org/blog/12209/introducing-the-dialog-element/) by default can be removed by pressing Esc, which in this case ruined user journey I originally came up with, so I had to drop a fallback for that. 
